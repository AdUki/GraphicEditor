...
QT_MOC_LITERAL(12, 122, 7)
    ...
    "Console\0executeCommand\0\0command\0"
    "terminateCommand\0nextCommand\0"
    "waitForCommand\0clear\0writeOutput\0data\0"
    "writeError\0writeSystem\0message\0"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->executeCommand((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 1: _t->terminateCommand(); break;
        case 2: _t->nextCommand(); break;
        case 3: _t->waitForCommand(); break;
        case 4: _t->clear(); break;
        case 5: _t->writeOutput((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 6: _t->writeError((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 7: _t->writeSystem((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Console::executeCommand)) {
                *result = 0;
            }
        }
        {
            typedef void (Console::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Console::terminateCommand)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Console::executeCommand(const QByteArray & _t1)
{
